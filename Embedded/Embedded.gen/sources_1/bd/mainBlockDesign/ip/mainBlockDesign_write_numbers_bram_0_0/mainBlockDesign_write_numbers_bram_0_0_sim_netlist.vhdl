...
--               /home/lsriw/Documents/RN/RN_proj/Embedded/Embedded.gen/sources_1/bd/mainBlockDesign/ip/mainBlockDesign_write_numbers_bram_0_0/mainBlockDesign_write_numbers_bram_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of mainBlockDesign_write_numbers_bram_0_0_write_numbers_bram is
  ...
  signal \address_reg[10]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \^finished_intr\ : STD_LOGIC;
  signal finished_intr_reg_i_1_n_0 : STD_LOGIC;
  signal finished_intr_reg_i_2_n_0 : STD_LOGIC;
  signal finished_intr_reg_i_3_n_0 : STD_LOGIC;
  signal finished_intr_reg_i_4_n_0 : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 10 downto 0 );
  signal prev_write : STD_LOGIC;
  signal startNumber_reg : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal startNumber_reg_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \address_reg[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \address_reg[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \address_reg[2]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \address_reg[7]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of finished_intr_reg_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of finished_intr_reg_i_3 : label is "soft_lutpair2";
begin
  address(10 downto 0) <= \^address\(10 downto 0);
  finished_intr <= \^finished_intr\;
FSM_sequential_state_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FDFDFDFD00FF0000"
    )
        port map (
...
\address_reg[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
finished_intr_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888888C8"
    )
        port map (
...
finished_intr_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
finished_intr_reg_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
finished_intr_reg_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
finished_intr_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
